...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center overflow-hidden">
      ...
      <svg
        className="absolute top-16 left-10 w-20 h-20 text-white opacity-10 rotate-12"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
      ...
      <svg
        className="absolute bottom-20 right-16 w-16 h-16 text-white opacity-10 -rotate-12"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
      ...
      <svg
        className="absolute top-1/2 right-10 w-10 h-10 text-white opacity-10 rotate-45"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 w-full">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-blue-100/80 text-lg max-w-xl leading-relaxed">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="h-13 px-8 py-3.5 bg-white text-[#1A6FA8] text-sm font-bold rounded-xl hover:bg-[#F7FAFE] active:scale-[0.99] transition-all shadow-[0_8px_24px_rgba(0,0,0,0.2)] flex items-center justify-center gap-2"
            >
              <svg
                width="16"
                height="16"
            ...
            <button
              ...
              className="h-13 px-8 py-3.5 border-2 border-white/40 text-white text-sm font-bold rounded-xl hover:bg-white/10 active:scale-[0.99] transition-all flex items-center justify-center gap-2"
            >
              <svg
                width="16"
                height="16"
          ...
          <div className="mt-6 flex flex-wrap gap-5">
            {[
              ...
              <div
                key={label}
                className="flex items-center gap-2 bg-white/10 border border-white/15 rounded-full px-4 py-2 text-white/80 text-xs font-semibold backdrop-blur-sm"
              >
