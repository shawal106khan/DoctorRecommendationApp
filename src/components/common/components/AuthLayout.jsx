...
const AuthLayout = ({ children }) => {
  return (
    <div className="min-h-screen bg-[#336aac] flex items-center justify-center px-4 py-8 sm:p-3 relative overflow-hidden">
      {/* Background circles */}
      ...
      {/* White card */}
      <div className="relative z-10 w-full max-w-sm bg-white rounded-2xl px-5 py-10 sm:px-6 sm:py-6 shadow-[0_20px_60px_rgba(0,0,0,0.20)]">
        {children}
      </div>
    </div>
  );
